 ...
 */
export function createSuccessResponse(data, message = 'Operation successful', meta = {}) {
  return {
    success: true,
    message,
    data,
 ...
 */
export function createErrorResponse(message, error = 'Error', statusCode = 500, details = null) {
  const response = {
    success: false,
    statusCode,
    error,
